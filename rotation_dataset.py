# -*- coding: utf-8 -*-
"""Rotation_Dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_btYeXBHcwLN8R-i31ruNIb6dPxYnVM-
...
for folder in demo_folders:
    if 'b' in folder:  # Skip folders containing 'b'
        continue
    ...
    try:
        ...
        for i in range(train_number):
            ...
            shutil.copytree(folder_name, new_folder_name)  # Copy the data to train folder
        ...
        for i in range(train_number, data_number):
            ...
            shutil.copytree(folder_name, new_folder_name)  # Copy the data to test folder
