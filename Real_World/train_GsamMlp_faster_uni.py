...
from GsamMlp5_discretized_new_uni2 import GsamMlp5
import numpy as np
...
# Setup Destination
MODEL_NAME = 'GSAMMLP5_unidrectional'
...
if __name__ == '__main__':
    ...
    if not os.path.exists(FIGURE_PATH):
     ...
     if torch.cuda.is_available():
        ...
        model = GsamMlp5().to(primary_device)
    ...
    for epoch in range(CONTINUE, 1000):
        ...
        for current_feat, goal_feat, labels in tqdm(train_dataloader, desc=f"Epoch {epoch+1}/{1000}"):
            ...
            optimizer.zero_grad()
            outputs, _ = model(current_feat, goal_feat)
        ...
        with torch.no_grad():
            ...
            for current_images, goal_image, labels in train_dataloader:
                ...
                outputs, _ = model(current_images, goal_image)
